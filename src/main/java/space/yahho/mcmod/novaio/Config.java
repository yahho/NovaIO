...
@Mod.EventBusSubscriber(modid = NovaIO.MODID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class Config {
    ...
    private static final ForgeConfigSpec.IntValue PACKET_LEN = BUILDER.comment("Length of a packet data by byte").defineInRange("packetLen", 65536, 16384, Integer.MAX_VALUE);
